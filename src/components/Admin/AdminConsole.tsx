...
const AdminConsole = () => {
    ...
    const copy = useMemo<AdminCopy>(() => (isVietnamese ? {
        title: 'Admin Console',
        subtitle: 'Màn hình quản lý kho prompt: nhập, duyệt bản nháp, đưa vào chạy và khôi phục khi cần.',
        refresh: 'Làm mới',
        ...
        compilePathHint: 'Để trống = quét toàn bộ thư mục incoming đã cấu hình cho kho prompt',
        ...
        resolveTitle: 'Kiểm tra định tuyến prompt',
        ...
        formattedPrompt: 'Khối prompt runtime',
        moreSkills: 'skill khác',
        importOptions: 'Tùy chọn nhập nâng cao',
        matchedSkills: 'Prompt khớp',
        ...
        activityDefault: 'Đã cập nhật kho prompt',
        ...
        title: 'Admin Console',
        subtitle: 'Manage the prompt catalog with a simple flow: import, review, publish, and roll back if needed.',
        refresh: 'Refresh',
        ...
        compilePathHint: 'Leave empty to scan the configured prompt-catalog incoming folder',
        ...
        resolveTitle: 'Check prompt routing',
        ...
        formattedPrompt: 'Formatted runtime prompt block',
        moreSkills: 'more skills',
        importOptions: 'Advanced import options',
        matchedSkills: 'Matched prompts',
        ...
        activityDefault: 'Updated prompt catalog',
